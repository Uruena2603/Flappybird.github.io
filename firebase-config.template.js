...
function initializeFirebaseConfig() {
  try {
    if (isFirebaseConfigured()) {
      ...
      console.warn("⚠️ Firebase Config: Configuración incompleta - modo offline");
      console.log("🔧 Para habilitar Firebase, configure las credenciales en firebase-config.js");
      return false;
    }
  } catch (error) {
